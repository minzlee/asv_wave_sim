...
* Change all to package://asv_wave_sim_gazebo
* Rm fake asv_wave_sim_gazebo/models and make it work, needs testing
...
* Add fake models in asv_wave_sim_gazebo, wamv_description, wamv_gazebo to avoid GAZEBO_MODEL_PATH errors
...
* Added Batteries to asv_wave_sim_gazebo/models(sdf format) and macro(urdf format) to place on wamv
